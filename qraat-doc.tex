...
\path{rmg-node check}. This is how the site periodically checks its status. 
...
\path{rmg} is also capable of some other miscellaneous taks that don't cause state 
